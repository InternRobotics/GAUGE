    ...
    <main>
      ...
      <section className="benchmark-composition" aria-labelledby="composition-title">
        ...
        <div className="composition-grid">
          ...
          <article><div className="capture-apparatus" aria-label="Sixteen-camera motion-capture volume recording at 180 hertz"><i className="capture-node node-a" /><i className="capture-node node-b" /><i className="capture-node node-c" /><i className="capture-node node-d" /><div className="capture-volume-mark"><span>16</span><b>CAMERAS</b></div><small>180 HZ</small></div><div className="composition-copy"><h3>Repeated measurement</h3><p><b>≈1,560</b> real trials are recorded by 16 infrared cameras surrounding a calibrated capture volume at <b>180 Hz</b>.</p></div></article>
