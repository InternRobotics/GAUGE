    ...
    <main>
      ...
      <section className="section world-models">
        ...
        <div className="evidence-stack">
          ...
          <article className="world-video-card"><video autoPlay muted loop playsInline preload="metadata"><source src={assetUrl("world-model-results/bouncing-ball/physics/cosmos3-super-i2v.mp4")} type="video/mp4" /></video><div className="world-video-label"><span>Cosmos3-Super-I2V · Negative prompt</span><b>Bouncing ball</b></div><div className="world-video-reading"><h3>The ball bounces, but free fall is far too slow.</h3><p><strong>0.088 m/s²</strong><span>Recovered free-fall acceleration · Real: 9.81 m/s² · QFI: 12.50</span></p></div></article>
