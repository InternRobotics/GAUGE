    ...
    <main>
      ...
      <section className="academic-hero" id="top">
        ...
        <figure className="academic-framework">
          ...
          <figcaption><span><strong>Benchmark framework</strong> · real-world ground truth anchors both evaluation tracks.</span><a href={assetUrl("paper/overview.png")} target="_blank" rel="noreferrer">Open full figure ↗</a></figcaption>
        </figure>
      </section>

      <section className="benchmark-composition" aria-labelledby="composition-title">
        <div className="composition-intro"><p className="section-kicker">Benchmark overview</p><h2 id="composition-title">Benchmark Overview</h2><p>GAUGE comprises approximately 1,560 real-world experimental measurements spanning 22 task families, four physical regimes, and two evaluation tracks.</p></div>
      ...
      <section className="section world-models">
        <div className="world-copy"><div className="section-kicker light">04 / World-model diagnosis</div><h2>Generated videos can look plausible yet still predict the wrong physics.</h2><p>These are generated videos, not the real trials above. GAUGE tracks the moving object in every frame, fits the expected law, then checks whether its scale and timing match reality.</p><a href="#world-model-lab">Compare all model readings <span>↓</span></a></div>
        <div className="evidence-stack">
          <article className="world-video-card"><video autoPlay muted loop playsInline preload="metadata"><source src={assetUrl("world-models/slope-slider.mp4")} type="video/mp4" /></video><div className="world-video-label"><span>Seedance 2.0 · Standard prompt</span><b>Slope slider</b></div><div className="world-video-reading"><h3>Looks like a clean slide.</h3><p><strong>0.23 m/s²</strong><span>Recovered acceleration · Real: 2.58 m/s² · QFI: 781.51</span></p></div></article>
          <article className="world-video-card"><video autoPlay muted loop playsInline preload="metadata"><source src={assetUrl("world-models/pendulum.mp4")} type="video/mp4" /></video><div className="world-video-label"><span>Wan-2.7 · Physics-conditioned</span><b>Pendulum</b></div><div className="world-video-reading"><h3>A familiar swing, but the wrong clock.</h3><p><strong>R² 0.72</strong><span>Period: 1.87 s · Real: 1.06 s</span></p></div></article>
          <article className="world-video-card"><video autoPlay muted loop playsInline preload="metadata"><source src={assetUrl("world-models/bouncing-ball.mp4")} type="video/mp4" /></video><div className="world-video-label"><span>Cosmos3-Nano · Standard prompt</span><b>Bouncing ball</b></div><div className="world-video-reading"><h3>A bounce without gravity’s scale.</h3><p><strong>0.45 m/s²</strong><span>Real gravity: 9.81 m/s² · QFI: 2620.05</span></p></div></article>
